					...
					<div class="card-body">
						<form method="post" action="" id="" class="form-horizontal">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input name="boTitle" type="text" class="form-control" value="${free.feTitle }" placeholder="제목을 입력해주세요.">
								</div>
								<font color="red" style="font-size: 12px;">${errors.feTitle }</font>
							</div>
							<div class="form-group row mt-4">
								<label class="col-sm-2 control-label" >내용</label>
								<div class="col-sm-10">
									<textarea name="boContent" cols="50" rows="5" class="form-control" placeholder="content">${free.feContent }</textarea>
								</div>
								<font color="red" style="font-size: 12px;">${errors.feContent }</font>
							</div>
							<div class="form-group row mt-4">
							...
							<font color="red" style="font-size: 12px;">${faild }</font>
						</form>
					</div>
				</div>
			</div>
...
$(function(){
	...
	addBtn.on("click", function(){
		var title = $("#fetitle").val();		
		var content = CKEDITOR.instances.feContent.getData();	
	...
	cancelBtn.on("click", function(){
		location.href = "/free/detail.do?boNo=${free.feNo}";
	});
});
</script>
</html>
