					...
					<div class="card-body">
						<form method="post" action="/board/insert.do" id="boardForm" class="form-horizontal">
							...
							<div class="form-group row mt-4">
								...
								<div class="col-sm-10">
									<textarea name="boContent" id="boContent" cols="50" rows="5"
									 class="form-control" placeholder="content">${board.boContent }</textarea>
								</div>
...
// 		var content = $("#boContent").val();	// 내용 값: 일반적인 textarea 일 때 
		var content = CKEDITOR.instances.boContent.getData();	// 내용 값: CKEDITOR일 때 
