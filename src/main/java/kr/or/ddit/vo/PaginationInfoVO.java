...
public class PaginationInfoVO<T> {
	...
	private List<T> dataList;	// 결과를 넣을 데이터 리스트(각 페이지 당 조회된 목록 데이터)
	private String searchType;	// 검색 타입(제목, 작성자, 작성일 등)
	...
	public void setTotalRecord(int totalRecord) {
		// 총 게시글 수를 저장하고, 총 게시글 수를 페이지 당 나타낼 게시글 수로 나눠 총 페이지 수를 구한다
	...
	public String getPagingHTML() {
		...
		// endPage 만큼 반복되고 넘어가야 할 페이지가 존재하지 않는 상태라면 마지막 페이지가 포함되어 있는 block 영역이므로
		// totalPage만큼 반복됩니다.
